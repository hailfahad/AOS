...
public class AddServiceServiceLocator extends org.apache.axis.client.Service implements aos.AddServiceService {
    ...
    private java.lang.String AddService_address = "http://localhost:8080/Try50/services/AddService";
    ...
    public aos.AddService getAddService() throws javax.xml.rpc.ServiceException {
    ...
    public aos.AddService getAddService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            aos.AddServiceSoapBindingStub _stub = new aos.AddServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (aos.AddService.class.isAssignableFrom(serviceEndpointInterface)) {
                aos.AddServiceSoapBindingStub _stub = new aos.AddServiceSoapBindingStub(new java.net.URL(AddService_address), this);
                _stub.setPortName(getAddServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://aos", "AddServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://aos", "AddService"));
        }
